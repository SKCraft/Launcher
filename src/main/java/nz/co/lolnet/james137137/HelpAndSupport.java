...
public class HelpAndSupport {
    ...
    public static void Start() {
        ...
        int answer = JOptionPane.showOptionDialog(null,
                ...
                null);
        if (answer == 0) {
            Object[] options1_1 = {"I found an error/bug", "I have a suggestion for the Launcher", "I would like to submit a modpack"};
            ...
            Object[] options1_1 = {"I can't login", "I forgot my password", "I don't have a username"};
            answer = JOptionPane.showOptionDialog(null,
                    "What is the problem.",
                    "Account Help",
                    JOptionPane.YES_NO_CANCEL_OPTION,
    ...
    private static void CantLogin() {
        Object[] options1_2 = {"In game", "Launcher"};
        int answer = JOptionPane.showOptionDialog(null,
    ...
    private static void CantLogin_InGame() {
        Object[] options1_2 = {"Yes", "No", "I don't know..."};
        int answer = JOptionPane.showOptionDialog(null,
                "Are you banned?",
                "Account Help",
                JOptionPane.YES_NO_CANCEL_OPTION,
                ...
                null);
        if (answer == 0) {
            openURL("https://lolnet.co.nz/viewforum.php?f=34");
        } else if (answer == 1) {
    ...
    private static void sendToMinecraftSupportPage() {
        Object[] options1_2 = {"Take me there", "Cancel"};
        int answer = JOptionPane.showOptionDialog(null,
                ...
                null);
        if (answer == 0) {
            openURL("https://lolnet.co.nz/posting.php?mode=post&f=134");
        }
    }
    ...
    private static void sendToLauncherBugHelp() {
        Object[] options1_2 = {"Take me there","Make a post now", "Cancel"};
        int answer = JOptionPane.showOptionDialog(null,
                ...
                null);
        if (answer == 0) {
            openURL("https://lolnet.co.nz/viewtopic.php?f=135&t=5684");
        } else if (answer == 1)
        {
            openURL("https://lolnet.co.nz/posting.php?mode=post&f=135");
        }
    }
    ...
    private static void sendToLauncherRequest() {
        ...
        int answer = JOptionPane.showOptionDialog(null,
                ...
                null);
        if (answer == 0) {
            openURL("https://lolnet.co.nz/viewforum.php?f=135");
        }
    }
}
